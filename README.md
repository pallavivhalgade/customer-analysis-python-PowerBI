...
│
├── analysis/                                   
│   ├── Customer_Shopping_Behavior_Analysis.ipynb   # Python notebook (EDA & cleaning)
...
│
└── reports/                                    
    ├── Business Problem Document.pdf                # Problem statement & understanding
    ├── Customer Shopping Behavior Analysis.pdf      # Final written report
    └── Customer-Shopping-Behavior-Analysis.pptx     # Presentation for stakeholders
...
## Project Links
- 🔗 **GitHub Repository:** [https://github.com/pallavivhalgade/customer-analysis-python-PowerBI.git]
